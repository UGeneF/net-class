...
using SevenSem.Auth.Impl.Ioc;
using Sevensem.Chats.Ioc;
using SevenSem.Identity.Impl.IoC;
...
namespace SevenSem.Rest
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(o =>
            {
                o.SwaggerEndpoint("/swagger/v1/swagger.json", "QA-r-Tinder Backend Contract");
            });
        }
    }
}